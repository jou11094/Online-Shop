...
class ProductsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categoryOfProducts = $product->categories()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','categoriesAll', 'categoryOfProducts'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // reInsert Cateogries For products.
        if($request->categories){
            foreach($request->categories as $categorForProducts){
                CategoryProduct::create([
                    'product_id' => $id,
                    'category_id'=> $categorForProducts,
                ]);
            }
